...
<body>
  ...
  <div class="appbar">
    <div class="logo-brand">
      ...
      <a href="/contactaf" class="brand">upgrist</a>
    </div>
    <div class="navbar-menu">
      <a href="/contactaf" class="nav-link">Home</a>
  ...
  <div class="contact-support">
    ...
    <form action="/email/contact" method="post">
  ...
  <script>
    ...
    // Display alert based on the server response
    document.addEventListener("DOMContentLoaded", () => {
      const status = new URLSearchParams(window.location.search).get("status");
      if (status != "Failed to send email. Please try again later.") {
